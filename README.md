...
Code and data for "The Relational Structure of Corporate Ignorance Production"
...
- 3 pre-processing .R files for consultation only (pre1_entitiy.R, pre2_network.R, pre3_remdata.R)
- 1 data file (sdtrem.csv)
- 1 .R file that can be run by users (1_models) using the data file

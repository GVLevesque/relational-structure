...
Code and data for "The Relational Structure of Corporate Ignorance Production"<br>
Gabriel V. Lévesque, 2026
...
- 3 pre-processing .R files for consultation only (pre1_entitiy.R, pre2_network.R, pre3_remdata.R)<br>
- 1 data file (sdtrem.csv)<br>
- 1 .R file that can be run by users (1_models) using the data file<br>
